...
namespace RASM.ThirdParty.SerializeReferenceUI.Core
{
    public static class ManagedReferenceUtility
    {
        /// Creates instance of passed type and assigns it to managed reference
        public static object AssignNewInstanceOfTypeToManagedReference(this SerializedProperty serializedProperty,
            Type                                                                               type)
        {
        ...
        public static IEnumerable<Type> GetAppropriateTypesForAssigningToManagedReference(this SerializedProperty property,
            List<Func<Type, bool>> filters = null)
        {
        ...
        public static IEnumerable<Type> GetAppropriateTypesForAssigningToManagedReference(Type fieldType,
            List<Func<Type, bool>>                                                             filters = null)
        {
            ...
            foreach (var type in derivedTypes)
            {
                ...
                ) // Structs still can be created (strangely)
                    continue;
