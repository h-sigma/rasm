...
namespace RASM.ThirdParty.SerializeReferenceUI.Core
{
    public static class SerializeReferenceGenericSelectionMenu
    {
        ...
        private static void FillContextMenu(IEnumerable<Func<Type, bool>> enumerableFilters, GenericMenu contextMenu,
        ...
        private static void AddItemToContextMenu(Type type, GenericMenu genericMenuContext, SerializedProperty property)
        {
            ...
            var entryName    = Event.current.alt ? type + "  ( " + assemblyName + " )" : type.ToString();
